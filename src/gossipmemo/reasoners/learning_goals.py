...
def goal_candidate_prompt(
    ...
    return (
        ...
        "person's part in the user's own life. When an entry already has real specificity, "
        "or an open goal already digs into a topic, prefer expanding a thin entry or an "
        "uncovered sibling over deepening that entry further. Write each direction in the "
